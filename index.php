...
// Habilitar erros (desative em produção)
...
$routes = [
    ...
    'gere-4020' => 'reinf/dashboar4020.php',
...
if (isset($routes[$page])) {
    ...
    if (strpos($view_file, '.php') !== false) {
        ...
        // Se for uma URL para redirecionar (como logout)
        header('Location: ' . BASE_URL . $view_file);
        exit;
    }
} else {
    // Rota não encontrada
